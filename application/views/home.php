<div class="col-xl-3 col-md-6">
    <div class="card bg-c-yellow update-card">
        <div class="card-block">
            <div class="row align-items-end">
                <div class="col-8">
                    ...
                    <h6 class="text-white m-b-0">Penyedia Jasa</h6>
                </div>
        ...
        <div class="card-footer">
            <a href="#" class="text-white m-b-0">Detail Data</i></a>
        </div>
    </div>
</div>
<div class="col-xl-3 col-md-6">
        ...
        <div class="card-block">
            <div class="row align-items-end">
                <div class="col-8">
                    ...
                    <h6 class="text-white m-b-0">Konsultan</h6>
                </div>
                <div class="col-4 text-right">
        ...
        <div class="card-block">
            <div class="row align-items-end">
                <div class="col-8">
                    ...
                    <h6 class="text-white m-b-0">PPK</h6>
                </div>
                <div class="col-4 text-right">
        ...
        <div class="card-block">
            <div class="row align-items-end">
                <div class="col-8">
                    ...
                    <h6 class="text-white m-b-0">Kegiatan/Paket</h6>
                </div>
                <div class="col-4 text-right">
        ...
        <div class="card-block">
            <div class="row m-b-25">
                <div class="col-auto p-r-0">
                    <div class="u-img">
                        <img src="<?= base_url(); ?>assets/template/files/assets/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                        <img src="<?= base_url(); ?>assets/template/files/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                    </div>
                </div>
                <div class="col">
                                    ...
                                    <tr>
                                        <td class="b-none">
                                            <a href="#!" class="align-middle">
                                                <img src="<?= base_url(); ?>assets/template/files/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
        ...
        <div class="row m-l-0 m-r-0">
            <div class="col-sm-4 bg-c-lite-green user-profile">
                <div class="card-block text-center text-white">
                    <div class="m-b-25">
                        <img src="<?= base_url(); ?>assets/template/files/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                    </div>
                ...
                <div class="card-block">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h6 class="text-muted f-w-400"><a href="<?= base_url(); ?>assets/template/<?= base_url(); ?>assets/template/<?= base_url(); ?>assets/template/cdn-cgi/l/email-protection.htm" class="__cf_email__" data-cfemail="3a505f54437a5d575b535614595557">[email&#160;protected]</a></h6>
                        </div>
                        <div class="col-sm-6">
